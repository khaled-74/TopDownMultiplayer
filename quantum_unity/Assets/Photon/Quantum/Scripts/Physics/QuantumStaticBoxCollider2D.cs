...
public class QuantumStaticBoxCollider2D : MonoBehaviour {
  ...
  void DrawGizmo(Boolean selected) {
    ...
    GizmoUtils.DrawGizmosBox(matrix, size, QuantumEditorSettings.Instance.StaticColliderColor, selected: selected, style: QuantumEditorSettings.Instance.StaticColliderGizmoStyle);
  }
#endif
}
